/*
  ...
  1. New Functions
    - auto_delete_listing_by_reports - Automatically delete listings with too many reports
    - process_listing_report - Process a listing report (approve/reject)
    - get_listing_report_count - Get the number of reports for a listing
    - get_message_report_count - Get the number of reports for a message

  2. New Tables
    - message_reports - Store reports for messages
*/
...
-- Create trigger for auto-deleting listings
