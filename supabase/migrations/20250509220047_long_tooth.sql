...
DROP POLICY IF EXISTS "Anyone can read vehicle history reports" ON vehicle_history_reports;
DROP POLICY IF EXISTS "Authenticated users can insert vehicle history reports" ON vehicle_history_reports;
