/*
  # Fix Listing Reports RLS Policy for Admin Reporting

  1. Changes
    - Drop existing policies that might conflict
    - Create a comprehensive policy for admins to manage all listing reports
    - Create separate policies for regular users to create and read reports
*/
